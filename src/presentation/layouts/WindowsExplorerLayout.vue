...
const handleDeleteFile = (fileId: string) => {
  ...
  deleteMessage.value = 'Are you sure you want to delete this file? This action cannot be undone.'
...
<template>
  <div class="h-screen bg-win-gray font-segoe flex flex-col">
    ...
    <ToolbarView
      ...
      :selected-file="fileStore.selectedFileId"
      :has-selection="
        folderStore.selectedMainFolderId !== null || fileStore.selectedFileId !== null
      "
